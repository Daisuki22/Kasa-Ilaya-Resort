...
$config = [
    'db' => [
        'host' => getenv('KASA_DB_HOST') ?: (getenv('MYSQLHOST') ?: (getenv('MYSQL_HOST') ?: '127.0.0.1')),
        'port' => getenv('KASA_DB_PORT') ?: (getenv('MYSQLPORT') ?: (getenv('MYSQL_PORT') ?: '3306')),
        'name' => getenv('KASA_DB_NAME') ?: (getenv('MYSQLDATABASE') ?: (getenv('MYSQL_DATABASE') ?: 'kasa_ilaya_resort')),
        'user' => getenv('KASA_DB_USER') ?: (getenv('MYSQLUSER') ?: (getenv('MYSQL_USER') ?: 'root')),
        'pass' => getenv('KASA_DB_PASS') ?: (getenv('MYSQLPASSWORD') ?: (getenv('MYSQL_PASSWORD') ?: '')),
        'charset' => 'utf8mb4',
    ],
    'project_name' => $projectName,
    'api_path' => getenv('KASA_API_PATH') ?: '/' . $projectName . '/api',
    'uploads_path' => __DIR__ . '/uploads',
    'frontend_url' => rtrim((string) (getenv('KASA_FRONTEND_URL') ?: (getenv('RAILWAY_PUBLIC_DOMAIN') ? 'https://' . getenv('RAILWAY_PUBLIC_DOMAIN') : '')), '/'),
    'mail' => [
